...
// ... (All your CheckoutSystem class definition) ...
...
function completeOrder(paymentMethod) {
    ...
    // ... (rest of your email sending and localStorage clearing logic) ...
    
    return orderNumber; // IMPORTANT: Ensure you return the orderNumber!
}
// ... (rest of the file)